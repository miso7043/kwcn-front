// Auto-generated from info_job4.json (ko)
// UI에서 쓰이는 한글 텍스트
export const job4Text = {
	interviewPrepStepsSectionTitle: "인터뷰 준비 단계",
	starMethodSectionTitle: "STAR 기법 활용하기",
	starMethodGuide: "행동 기반 질문에 체계적으로 답변하는 방법:",
	postInterviewSectionTitle: "면접 후 할 일",
	title: "JOB ACADEMY",
	lectureSubtitle: "면접 준비",
	pageTitle: "Job Academy - Lecture 4",
	lecture4Goal: "인터뷰(Interview) 준비에 대해 배운다.",
	interviewPrep: "인터뷰 준비하기",
	interviewPrepSteps: [
		{
			title: "1단계: 회사 연구하기",
			tips: [
